...
import githubS from "/assets/stack/github.png"
...
function Main() {
    ...
    return (
        <WrapperM color={changer ? "#191919" : "transparent"}>
            ...
            <Screen color={!changer ? "#FFFFFF" : "#191919"}>
                <WrapperS color={!changer ? "#FFFFFF" : "#191919"}>
                    ...
                    <Images>
                        ...
                        <a href="https://github.com/Dirakli" target="_blank"><img src={githubS} alt="github" /></a>
